...
public class CommonThingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnQuiz).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CommonThingsActivity.this, QuizActivity.class));
            }
        });
        findViewById(R.id.imgHomes).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CommonThingsActivity.this, Dashboard.class));
            }
        });
    }
    ...
    public void setData() {
        ...
        try {
            input = assetManager.open("words.txt");
